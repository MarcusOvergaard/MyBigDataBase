...
FROM (
    VALUES
        ...
        ('ILO', 'ILOSTAT', 'ILOSTAT bulk and API labor statistics catalog', 'A', 'country-year-indicator', 'periodic', 'https://rplumber.ilo.org/data/', 'api', 'https://rplumber.ilo.org/data/', 'json', FALSE, 'First narrow live slice validated for total unemployment rate ages 15+; broader labor indicators still need explicit slice-by-slice modeling.', TRUE, TRUE),
        ('UN', 'UN_COMTRADE_ANNUAL', 'UN Comtrade annual merchandise trade dataset', 'A', 'country-year-indicator', 'periodic', 'https://comtradeplus.un.org/TradeFlow', 'api', 'https://comtradeplus.un.org/api/Trade/', 'json', FALSE, 'First narrow live slice validated for annual total goods exports and imports against World partner totals; broader partner and product grains still need explicit modeling.', TRUE, TRUE)
...
FROM (
    VALUES
        ...
        ('ILOSTAT', 'api', 'https://rplumber.ilo.org/data/', 'json', FALSE, 'First narrow live slice validated for total unemployment rate ages 15+; broader labor indicators still need explicit slice-by-slice modeling.', TRUE),
        ('UN_COMTRADE_ANNUAL', 'api', 'https://comtradeplus.un.org/api/Trade/', 'json', FALSE, 'First narrow live slice validated for annual total goods exports and imports against World partner totals; broader partner and product grains still need explicit modeling.', TRUE),
